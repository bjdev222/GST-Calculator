    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse(
                        "https://play.google.com/store/apps/details?id=com.infinite.gstcalculator"));
        ...
        more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://search?q=pub:INFINITE DEVELOPERS")));
                } catch (android.content.ActivityNotFoundException anfe) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/search?q=pub:INFINITE DEVELOPERS")));
                }
        ...
        //banner
        adView2 = new AdView(this, "1258758284477521_1259735561046460", AdSize.BANNER_HEIGHT_50);
